...
for number in numbers:
    #Присваиваем флагу is_prime значение Ложь
    is_prime = False
    ...
    if number > 1:
        ...
        for i in range(2, number):
            ...
            if ost == 0:
               #присваиваем is_prime значение Истина
               is_prime = True
    # иначе если число равно 1
    else:
        #переход в начало цикла
        continue
    # Если is_prime равно False
    if is_prime == False:
        #добавляем в список простых чисел число
       primes.append(number)
    #Иначе, is_prime равно True, добавляем число в список составных чисел
    else:
